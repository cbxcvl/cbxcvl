...
[![Hacking Club](https://img.shields.io/badge/hacking%20club-top%208-0a0a0a?style=flat-square&logo=hackthebox&logoColor=white)](https://app.hackingclub.com/profile/user/12763)
...
![Nuclei](https://img.shields.io/badge/Nuclei-000000?style=flat-square&logo=protonmail&logoColor=white)
![Subfinder](https://img.shields.io/badge/Subfinder-000000?style=flat-square)
![Naabu](https://img.shields.io/badge/Naabu-000000?style=flat-square)
...
| Certification | Focus |
|---|---|
| **CRTA** — Certified Red Team Analyst | Red Team Operations |
| **CRT-ID** — Red Team Infrastructure Developer | Infra for Red Team |
| **CPPS** — Certified Phishing Prevention Specialist | Social Engineering |
| **CCEP** — Certified Cybersecurity Educator Professional | Security Education |
| **Multicloud Network Associate** | Cloud Networking |
...
|---|---|---|
| [**Noctalia Shell**](https://github.com/noctalia-dev/noctalia-shell) | Bluetooth auto-connect for trusted devices — [PR]([https://github.com/noctalia-dev/noctalia-shell/commit/cfaf900f3f7fe5975b6adbe6cb9cafca7497f3da](https://github.com/noctalia-dev/noctalia-shell/pull/1981)) · shipped in v4.6.2 | 4.3k+ ⭐ |
...
> YAML-based workflows · Subfinder/Nuclei/Httpx/Naabu integration · Change detection · Discord & Telegram notifications · Real-time dashboard
...
```
 ⚔️ break → understand → secure → repeat
```

![](https://komarev.com/ghpvc/?username=cbxcvl&color=000000&style=flat-square&label=visitors)
